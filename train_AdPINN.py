...
from model.AdPINN import plot_trajectory_PINN, plot_losses, trainAdPINN, total_PINN_loss
...
'''
updated_params,new_mq, losses, [opt_state, opt_statemq] = trainAdPINN(all_initial_params, t, lb, ub, [v_train, x_train], lamda = lamda,\
...
'''
plot_trajectory_PINN(normalized_predict, updated_params, t, [x_train, x_train],\
